...
public class Samples {
    ...
    public static class Sample {
        ...
        public Sample(@NonNull Sample sample) {
            this(sample.name, sample.contentId, sample.provider, sample.uri, sample.type);
        }
    ...
    public static final Sample[] TEST_DASH_VIDEO_H264_MP4_CLEAR = new Sample[]{
            new Sample("Smurf DASH (MP4,H264)",
                    "http://demo.unified-streaming.com/video/smurfs/smurfs.ism/smurfs.mpd",
                    PlayerActivity.TYPE_DASH),
            new Sample("Manifest DASH (MP4,H264)",
